...
|---|---|---|
| [`odoo19-coding-guidelines`](./skills/odoo19-coding-guidelines/) | Official Odoo 19 coding guidelines for module structure, XML records, Python style, ORM conventions, translations, JS, SCSS, and security review | Initial |
