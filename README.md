...
|---|---|---|
| [`odoo19-coding-guidelines`](./skills/odoo19-coding-guidelines/) | Official Odoo 19 coding guidelines for module structure, XML records/accessibility, Python style, ORM conventions, field tracking, translation export, JS, SCSS, and security review | Initial |
