...
| Python style, string quotes, English source text, method structure, imports, translations | `references/python.md` |
...
- XML records use consistent attribute order, grouped models, stable external ids, proper multi-line attribute indentation, and minimal `<data>` wrappers.
