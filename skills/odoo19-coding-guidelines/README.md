...
This skill helps assistants write and review Odoo modules with the official Odoo 19 coding style: module structure, XML records, Python idioms, Odoo naming conventions, translations, JavaScript, SCSS, and security pitfalls.
